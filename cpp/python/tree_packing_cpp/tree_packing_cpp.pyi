...
class ALNS(Optimizer):
    def __init__(self, ruin_operators: list[Optimizer], recreate_operators: list[Optimizer], reaction_factor: float = 0.009999999776482582, reward_improve: float = 1.0, reward_no_improve: float = 0.0, min_weight: float = 0.0010000000474974513) -> None:
        ...
...
class NoiseOptimizer(Optimizer):
    def __init__(self, noise_level: float = 0.009999999776482582) -> None:
        ...
class Optimizer:
...
class RandomRecreate(Optimizer):
    def __init__(self, max_recreate: int = 1, box_size: float = 5.0, delta: float = 0.3499999940395355) -> None:
        ...
class RandomRuin(Optimizer):
    def __init__(self, n_remove: int = 1) -> None:
        ...
